...
def denoise(runs_sb, method=None, plot=False, pause_plot=1):
    """
    ...
    :param plot:        boolean whether to plot the results of the denoising algorithm for graphical assertion of the
                        performance of the method
    :param pause_plot:  the duration in second to show the results for each delay (used in combination with "plot=" flag
                        to interface with "visualize" function)
    :return:            an instance of the DataStitchingNoiseReduced class containing all the required information
    """
    ...
    return runs_sb_cleared, st_noise_df, p2p_noise_df, results
