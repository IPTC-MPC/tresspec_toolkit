...
def rapidscan(wrkpath, readparameters=False, temporalresolution=0, timestepsbeforezero=200):
    ...
    ts = cols - 1
    tsbz = par.timeslices_before_zero
    ...
    dod = pd.DataFrame(data[:, 1:], index=wavenumbers, columns=timeaxis)


    return dod, timeaxis, par
